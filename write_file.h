...
long double simu_markov(long double Motif_R_V[7], int seq_number,int length_local_1, continuous pp[5],continuous AveScore_V[7],continuous score_scan,continuous **scoreM);
